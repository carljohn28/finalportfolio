...
= 1.0.9 ==
* selective refresh function added for header text
* Removed extra shadow for header

= 1.0.8 ==
* Fixed header image text issue

= 1.0.7 ==
1. More responsive mobile menu
2. Search icon added in the header
3. Logo width issue fixed
= 1.0.6 ==
1. Mobile menu issue fixed
= 1.0.5 ==
1. Fixed - PHP error 
= 1.0.4 ==
